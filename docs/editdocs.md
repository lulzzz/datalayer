---
layout: docwithnav
title: Contributing to the Datalayer Documentation
---
...
$( document ).ready(function() {
    if(forwarding) {
        ...
        $("#continueEditButton").attr("href", "https://github.com/datalayer/datalayer/edit/{{ page.docsbranch }}/" + forwarding)
...
<p><a class="button" href="https://github.com/datalayer/datalayer/">Browse this site's source code</a></p>
