...
# CHANGE_MINIKUBE_NONE_USER=true minikube start --kubernetes-version v1.8.0 --cpus 8 --memory 8192 --insecure-registry --vm-driver none
...
```
cd /sdk/specs/k8s
kubectl apply -f echo/echo-app.yaml
